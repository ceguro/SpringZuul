...
*/
    ...
    public ResponseEntity findById3(
        ...
        return ResponseEntity.ok("{\"empresa\":{\"codigo\":\"ERHV\",\"orden\":76,\"tipoEmpresa\":\"G\",\"nombre\":\"XXXX No Tributarios\"," +
                ...
                "\"idDeuda\":\"00100026137501\",\"descDeuda\":\"XXXX NO TRIBU\",\"leyPago\":\"COMPROBANTE VALIDO DE PAGO.CONSERVELO.\"," +
    ...
    private void logs(HttpServletRequest request) {
